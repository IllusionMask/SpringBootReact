...
import com.hoaxify.springbootreact.service.FileService;

@RunWith(SpringRunner.class)
@ActiveProfiles("test")
public class FileServiceTest {
	//UnitTest no need @SpringBootTest
	
	FileService fileService;
	
	AppConfiguration appConfiguration;
	
	//This is unit test, therefore initialize instances manually
	@Before
	public void init() {
		...
		//WebConfifguration not triggered
